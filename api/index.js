...
function createDatabasePoolOptions(connectionString) {
  ...
  return {
    ...
    ...isTiDbPublicEndpoint ? { ssl: { minVersion: "TLSv1.2", rejectUnauthorized: true } } : {}
  };
}
